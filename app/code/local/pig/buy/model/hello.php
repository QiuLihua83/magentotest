...
class Pig_Buy_Model_Hello{
	
	const FLAG_SHOW_CONFIG = 'showConfig';
	const FLAG_SHOW_CONFIG_FORMAT = 'showConfigFormat'; private $request;
	public function checkForConfigRequest($observer) {
 	...
 	const FLAG_HELLO = 'hello';
	
 	public function hi($observer)
 	{
 		$this->request = $observer->getEvent()->getData('front')->getRequest();
 		if($this->request->{self::FLAG_HELLO} === 'true')
 		{
 			echo "hello";
 		}
 		echo "hello";
